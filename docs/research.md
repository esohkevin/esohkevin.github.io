...
<p style="background-color: rgba(215, 215, 215, 0.5); color: gray; padding: -20rem 1.5rem 1.5rem; text-align: left; border-radius: 0.4rem; margin-top: 30px;">
  <span style="background-color: rgba(110, 50, 50, 0.9); color: rgba(250, 250, 250, 1.0); border-radius: 0.5rem; padding: 0.55rem;">
