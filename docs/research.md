...
<span style="background-color: rgba(100, 20, 5, 0.9); color: rgba(250, 250, 250, 1.0); border-radius: 0.5rem; padding: 0.55rem; margin-bottom: -100px; margin-left: 35px; float: left;">
  <em>My contribution</em>
</span>
<span style="background-color: rgba(215, 215, 215, 0.5); color: gray; padding: 1.5rem; text-align: right; border-radius: 0.4rem; margin: 25px 50px 25px; float: right;">
